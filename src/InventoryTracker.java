...
public class InventoryTracker {
    ...
    private static void addItem(ArrayList<InventoryItem> items, Scanner scanner) {
        ...
        items.add(createItem(items, itemName, quantity, category));
    }
    ...
    private static InventoryItem createItem(ArrayList<InventoryItem> items, String name, int quantity, String category) {
        if (category.equalsIgnoreCase("food")) {
            ...
            return new Drinks(name, quantity);
